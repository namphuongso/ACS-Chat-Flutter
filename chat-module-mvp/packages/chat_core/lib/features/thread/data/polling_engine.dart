...
class PollingEngine {
  PollingEngine({
    ...
    required Future<List<Message>> Function({required String? startTime}) fetchNewMessages,
  }) : _fetch = fetchNewMessages;

  final String threadId;
  final Duration baseInterval;
  final Future<List<Message>> Function({required String? startTime}) _fetch;
  ...
  Duration _currentInterval() {
    ...
    final backoffSeconds = min(60, baseInterval.inSeconds * pow(2, _consecutiveErrors).toInt());
